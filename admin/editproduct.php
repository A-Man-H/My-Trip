	...
	<div class="holecontainer" style=" padding-top: 20px; padding: 0 20%">
		<div class="container signupform_content ">
			<div>
				...
				<div style="float: left;background-color:#000;border:1px solid #fff;border-radius:16px">
				<?php 
					echo '
						<div class="" >
							...
							<form action="" method="POST" class="registration">
								<div class="signup_form">
									...
									<div >
											...
											<input name="piece" style="margin-left: 0px; id="piece" required="required" class="piece signupbox" type="text" size="30" value="'.$piece.'" >
											</td>
											</div></br>
									...
									<div>
										...
										font-style: italic;margin-bottom: 3px;margin-top: 0px;padding: 14px;line-height: 25px;border-radius: 4px;border: 1px solid #4d0202;color: #b06a09;margin-left: 0;width: 300px;background-color: transparent;" class="">
												...
												<option value="back">BACK&Pack</option>
				...
				<?php
					echo '
						<ul style="float: right;">
							<li style="float: right; padding: 20px 0px 25px 25px;">
							...
							<li >
								<form action="" method="POST" class="registration" enctype="multipart/form-data">
										<div class="signup_form" >
											<div style="background-color:#000; padding:0px 0px 0px 35px;border:1px solid #fff;border-bottom-color:#000">
												<td>
													<input name="profilepic" style="width: 115px;" class="password signupbox" type="file" value="Add Picture">
												</td>
											</div>
											<div style="background-color:#000;padding:0px 0px 0px 35px;border:1px solid #fff;border-bottom-left-radius:16px;border-bottom-right-radius:16px;">
